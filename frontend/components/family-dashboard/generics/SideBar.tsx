...
const navItems = [
  { label: 'Dashboard', href: '/family', icon: LayoutGrid },
  { label: 'Raise Claim', href: '/family/raise-claim', icon: Plus },
  { label: 'My Claims', href: '/family/my-claim', icon: ClipboardList },
];
  ...
  return (
    <>
      ...
      <nav className="flex-1 space-y-3">
        {navItems.map((item) => {
          const isActive = item.href === '/family'
            ? pathname === '/family'
